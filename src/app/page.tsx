  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Join TsvTeach's waitlist! AI-powered learning tool for UK students preparing for GCSEs and A-levels. Help us validate our idea - launching at 1,000 signups." />
        <meta name="keywords" content="TsvTeach, AI tutor, GCSE, A-level, UK students, waitlist, learning tool, study helper, education technology, validation" />
        ...
        <meta property="og:description" content="Join our waitlist! AI-powered learning platform for UK students. Help validate our idea - launching at 1,000 signups." />
